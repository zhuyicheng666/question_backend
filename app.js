...
let getKnowledge = require('./routes/getKnowledge')
app.use('/getKnowledge',getKnowledge)
let getStuList = require('./routes/getStuList')
app.use('/getStuList',getStuList)
let addStudentByExcel = require('./routes/addStudentByExcel')
app.use('/addStudentByExcel',addStudentByExcel)
let saveHalfRecord = require('./routes/saveHalfRecord')
app.use('/saveHalfRecord',saveHalfRecord)
let searchHalfRecord = require('./routes/searchHalfRecord')
app.use('/searchHalfRecord',searchHalfRecord)
let searchHalfTime = require('./routes/searchHalfTime')
app.use('/searchHalfTime',searchHalfTime)

let deleteHalfRecord = require('./routes/deleteHalfRecord')
app.use('/deleteHalfRecord',deleteHalfRecord)
let updateHalfRecord = require('./routes/updateHalfRecord')
app.use('/updateHalfRecord',updateHalfRecord)
